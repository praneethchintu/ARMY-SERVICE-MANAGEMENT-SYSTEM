<%@ Page Title="" Language="C#" MasterPageFile="~/sup_admn/sup_admn_master.master"
    AutoEventWireup="true" CodeFile="emp_reg.aspx.cs" Inherits="sup_admn_emp_reg" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content" align="center">
                                                ...
                                                <div class="control-group" style="float: left; height: 45px; width: 100%">
                                                    <div style="width: 100%; float: left">
                                                        <ul class="nav nav-tabs">
                                                            <li class="left-side" id="Li2"><a href="#panel_employees">
                                                            <i class="icon-dashboard"></i>EMPLOYEES</a></li>
                                                            <li class="divider-vertical"></li>
                                                            <li class="left-side" id="dashboard"><a href="#toptabService" >
                                                            <i class="icon-dashboard"></i>REGISTRATION</a></li>
                                                            <li class="divider-vertical"></li>
                                                        </ul>
                                                    </div>
                                                </div>
        ...
        <ContentTemplate>
                                         ...
                                         <asp:TabContainer runat="server" Width="103.3%" ID="tabContainer1" Style="margin-left:-20px" TabIndex="0" ActiveTabIndex="0"
                CssClass="MyTabStyle" OnActiveTabChanged="Tab_Index_Changed" AutoPostBack="true" >
                                                                    ...
                                                                    <asp:UpdatePanel ID="updatePanel4" runat="server" >
                                                                     ...
                                                                     <table width="80%" style="margin-left: 10%;margin-top:10px" id="emptable" runat="server" >
                                                                         ...
                                                                         <tr>
                                                                             ...
                                                                             <td>
                                                                                 <asp:TextBox ID="txtemail" class="span9" runat="server" /><br />
                                                                             ...
                                                                             <td rowspan="3">
                                                                                 <img id="blah" src="#" alt="Preview" width="100" height="100" style="margin: 10px;
                                                                                 ...
                                                                                 <asp:RegularExpressionValidator ID="RegularExpressionValidator3" ForeColor="Red"
                                                                                     runat="server" ErrorMessage="Upload Only .gif, .jpg, .png Formats" ValidationGroup="emp_reg"
                                                                                     ControlToValidate="ImageFileUpload" ValidationExpression=".*\.([Gg][Ii][Ff])|.*\.([Jj][Pp][Gg])|.*\.([Bb][Mm][Pp])|.*\.([pP][nN][gG])">
                                                                         ...
                                                                         <tr>
                                                                             ...
                                                                             <td>
                                                                                 <asp:DropDownList ID="ddlDesiName" class="span9" runat="server">
                                                                                 </asp:DropDownList>
                    ...
                    Employee(s)</HeaderTemplate>
                                                                 ...
                                                                 <ContentTemplate>
                                                                     <asp:GridView ID="grid_employees" runat="server" AutoGenerateColumns="False" Width="80%"
                                                                         ...
                                                                         <Columns>
                                                                             ...
                                                                             <asp:TemplateField HeaderText="DOB">
                                                                                 <ItemTemplate>
                                                                                     <asp:Label ID="lbl_DOB" runat="server" Text='<%#Eval("dateofbirth") %>'></asp:Label>
                                                                                 </ItemTemplate>
                                                                             </asp:TemplateField>
                                                                             <asp:TemplateField HeaderText="Present Address">
                                                                                 <ItemTemplate>
                                                                                     <asp:Label ID="lbl_Present_Add" runat="server" Text='<%#Eval("present_address") %>'></asp:Label>
                                                                                 </ItemTemplate>
                                                                             </asp:TemplateField>
                                                                             <asp:TemplateField HeaderText="Permanent Address">
                                                                                 <ItemTemplate>
                                                                                     <asp:Label ID="lbl_Permanent_Add" runat="server" Text='<%#Eval("permanent_address") %>'></asp:Label>
                                                                                 </ItemTemplate>
                                                                             </asp:TemplateField>
                                                                             ...
                                                                             <asp:TemplateField HeaderText="Edit">
                                                                                 <ItemTemplate>
                                                                                     <div style="text-align: center">
                                                                                         <asp:ImageButton ID="imgbtn_EditDetails" runat="server" Width="15px" Height="15px"
                                                                                             autopostback="true" ImageAlign="Middle" OnClick="imgbtn_EditDetails_Click" ImageUrl="~/Icons/1385390972_write.png" /></div>
                                                                                 </ItemTemplate>
                                                                             ...
                                                                             <tr>
                                                                                 ...
                                                                                 <td>
                                                                                     ...
                                                                                     <div style="float: right">
                                                                                         <asp:Button ID="btnclose" runat="server" Text="Close" class="btn btn-danger btn-mini"
