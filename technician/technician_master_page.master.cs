...
public partial class technician_technician_master_page : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (HttpContext.Current.User.IsInRole("14") && HttpContext.Current.User.Identity.IsAuthenticated)
            {
