$.extend($.expr[":"], {
    "contains-ci": function (c, b, a, d) {
        return (c.textContent || c.innerText || $(c).text() || "").toLowerCase().indexOf((a[3] || "").toLowerCase()) >= 0
    }
});
$(function () {
    ...
    var a = new Date();
    a.setDate(a.getDate());
    $(".date").html(d[a.getDay()] + " " + a.getDate() + " " + b[a.getMonth()] + " " + a.getFullYear());
    ...
    $(".mainmenu li, .mainmenu div.dropdown").click(function () {
        var e = $(this).find(".dropdown-menu").parent().width();
    ...
    $(".collapseMenu").click(function () {
        if ($(this).hasClass("uncollapsed")) {
            $(".mainmenu").animate({
                ...
                $(".collapseMenu").removeClass("uncollapsed").animate({
                    left: 40
                }, 200);
                $(".deCollapse").css({
            ...
            $(".collapseMenu").addClass("uncollapsed").animate({
                left: 0
            }, 200, function () {
                $(".mainmenu").animate({
                    left: 0
    ...
    $("ul.nav-tabs li a").click(function () {
        var e = $(this).attr("href"),
            f = $(this).closest("ul.nav-tabs").find("li.active");
        $(e).parent().children().hide();
        $(e).fadeIn();
    ...
    $("div .input-append a.sidebar").click(function () {
        var e = $(this).attr("href");
        var f = $("div .input-append a span.add-on.active");
        f.removeClass("active");
        $(this).find("span.add-on").addClass("active");
        $(".hiddenContent>div").hide();
        $(e).fadeIn();
        if (c == 0) {
            $(".hiddenContent").stop().animate({
                right: 0
            }).css({
                display: "block"
            });
    ...
    $("#toggler").bind("change", function () {
        if ($(this).is(":checked")) {
            $(".toggle .slider-selection").animate({
                width: "0px",
                opacity: 0
            }, 200)
        } else {
    ...
    $(".usersBar").sparkline("html", {
        type: "bar",
        barColor: "#33B5E5",
        barWidth: 4,
        height: 25
    });
    $(".visitsBar").sparkline("html", {
        type: "bar",
        barColor: "#FF4444",
        barWidth: 4,
        height: 25
    });
    $(".ordersBar").sparkline("html", {
        type: "bar",
        barColor: "#99CC00",
        barWidth: 4,
        height: 25
    ...
    $(".minimizeElement, .minimizeTable").click(function () {
        if ($(this).hasClass("minimizeElement")) {
            ...
            if ($(this).hasClass("minimizeTable")) {
    ...
    $("i.moreOptions, .tableSettings").popover({
        ...
        var f = e.pageX > (e.view.outerWidth / 1.2);
        if (f === true) {
