<%@ Page Title="" Language="C#" MasterPageFile="~/incident_creation/MasterIncident.master" AutoEventWireup="true" CodeFile="incident.aspx.cs" Inherits="incident_creation_incident" %>
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <div class="floatingBox examples">
                                <div class="container-fluid">
                                    <div class="span12">
                                        <asp:Button ID="btnNewIncident" runat="server" Text="New Incident" CssClass="btn btn-mini btn-primary"
...
<%--                                                            <asp:ListItem Text="--select--" Value="0"></asp:ListItem>
                                            ...
                                            <asp:ListItem Value="3">LP002</asp:ListItem>--%>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <asp:Button ID="btnIncidentSave" runat="server" CssClass="btn  btn-primary" OnClick="btnIncidentSave_Click"
                                                            Text="Save" ValidationGroup="incident" />
                                                        <asp:Button ID="btnupdate" runat="server" Visible="false" Text="Update" CssClass="btn  btn-primary"
                                                            ValidationGroup="incident" OnClick="btnupdate_Click" />
                                                   
                                                         <asp:Button ID="btnIncidentClear" runat="server" Text="Clear" CssClass="btn " Style="margin-left: 10px"
                                                            OnClick="btnIncidentClear_Click" />
                                                 ...
                                                 <asp:TemplateField HeaderText="S.No" HeaderStyle-HorizontalAlign="Center"
                                                    ...
                                                    <asp:TemplateField HeaderText="CREATED ON">
                                                     ...
                                                     <asp:TemplateField HeaderText="OPEN TIME">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblOpen" runat="server" Text='<%#Eval("assign_time") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="SERVICE COMMENTS" HeaderStyle-Width="10%">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_Serv_Comments" runat="server" Text='<%#Eval("tehni_comments") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
